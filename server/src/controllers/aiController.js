...
exports.chat = async (req, res, next) => {
  try {
    ...
    logger.info(`AI Chat Request: "${message}", Has Image Context: ${!!context?.imageBase64}`);
    ...
    // We use gemini-2.5-flash as it's the recommended default for fast general text and multimodal
